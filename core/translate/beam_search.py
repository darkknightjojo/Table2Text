import torch
from core.translate import penalties
from core.translate.decode_strategy import DecodeStrategy
from core.utils.misc import tile
...
class BeamSearch(DecodeStrategy):
    ...
    Args:
        ...
        n_best (int): Don't stop until at least this many beams have
            reached EOS.
        global_scorer (module.translate.GNMTGlobalScorer): Scorer instance.
    ...
    def advance(self, log_probs, attn):
        ...
        torch.div(self.topk_ids, vocab_size, rounding_mode="trunc", out=self._batch_index)
