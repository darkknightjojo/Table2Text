...
from ..modules import context_gate_factory, GlobalAttention
from ..utils.rnn_factory import rnn_factory

from module.utils.misc import aeq
...
class RNNDecoderBase(DecoderBase):
    ...
    and required by :class:`~module.models.NMTModel`.
    ...
    Args:
       ...
       attn_type (str) : see :class:`~module.modules.GlobalAttention`
       attn_func (str) : see :class:`~module.modules.GlobalAttention`
       coverage_attn (str): see :class:`~module.modules.GlobalAttention`
       context_gate (str): see :class:`~module.modules.ContextGate`
       copy_attn (bool): setup a separate copy attention mechanism
       dropout (float) : dropout value for :class:`torch.nn.Dropout`
       embeddings (module.modules.Embeddings): embedding module to use
       reuse_copy_attn (bool): reuse the attention for copying
       copy_attn_type (str): The copy attention style. See
        :class:`~module.modules.GlobalAttention`.
    """
...
class StdRNNDecoder(RNNDecoderBase):
    ...
    See :class:`~module.decoder.decoder.RNNDecoderBase` for options.
