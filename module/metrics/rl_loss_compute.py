...
We provide code compatible with our version of module, meaning you should
...
import module
# from module.metrics.hss import HSS, HSA
from module.metrics.utils import WikiBIOCleaner
from module.utils.logging import logger
from module.utils.misc import sequence_mask
...
class RLLossCompute:
    ...
    def _stats(self, loss, baseline_rewards, rl_rewards, 
        ...
        return module.rl_trainer.RLStatistics(rl_loss=loss, rl_rewards=rl_rewards.item(), 
