...
from module.utils.misc import check_model_config
from module.utils.alignment import to_word_align
...
class ServerModel(object):
    ...
    def parse_opt(self, opt):
        """Parse the option set passed by the user using `module.opts`
       ...
       Returns:
        ...
        module.opts.translate_opts(parser)
