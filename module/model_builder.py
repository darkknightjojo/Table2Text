...
from module.models.model_switch import SwitchModel
from module.encoder import str2enc
from module.decoder import str2dec

from module.modules import Embeddings, VecEmbedding, CopyGenerator
from module.modules.util_class import Cast
from module.utils.misc import use_gpu
...
def build_base_model(model_opt, fields, gpu, checkpoint=None, gpu_id=None):
    ...
    if not model_opt.copy_attn:
        if model_opt.generator_function == "sparsemax":
            gen_func = module.modules.sparse_activations.LogSparsemax(dim=-1)
        else:
